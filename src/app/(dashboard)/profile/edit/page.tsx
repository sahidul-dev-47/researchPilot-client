  ...
  if (error || !user) {
    return (
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="text-xl font-bold text-foreground mb-2">Failed to load user profile</h1>
        <p className="text-sm text-muted-foreground max-w-md mb-6">
          Could not fetch user details for editing. Please check your network connection.
        </p>
